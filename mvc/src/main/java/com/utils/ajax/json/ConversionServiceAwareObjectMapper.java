...
public class ConversionServiceAwareObjectMapper extends ObjectMapper {
	...
	public ConversionServiceAwareObjectMapper(ConversionService conversionService) {
		...
		SerializationConfig sconfig = new SerializationConfig(DEFAULT_INTROSPECTOR, introspector, _visibilityChecker);
		DeserializationConfig dconfig = new DeserializationConfig(DEFAULT_INTROSPECTOR, introspector, _visibilityChecker);
