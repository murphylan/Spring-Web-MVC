...
import com.utils.poi.DummyDataFetcher.TemperatureAnomaly;
...
public class ExcelExportUtil {
	...
	public Workbook exportExcelWorkbook() {
		TemperatureAnomaly[] temperatureAnomalyArray = DummyDataFetcher
				.getDummyData();
	...
	private void generateContent(Sheet s,
			TemperatureAnomaly[] temperatureAnomalys) {
	...
	private Map<String, CellStyle> createStyles(Workbook wb) {
		...
		numberCellStyle.setFillBackgroundColor(HSSFColor.LIGHT_BLUE.index);
	...
	public static void main(String[] args) throws IOException {
		...
		// 生成Excel文件.
		Workbook wb = excelExportutil.exportExcelWorkbook();
		ByteArrayOutputStream os = new ByteArrayOutputStream();
		String targetfile = "C:/out.xls";// 输出文件名
