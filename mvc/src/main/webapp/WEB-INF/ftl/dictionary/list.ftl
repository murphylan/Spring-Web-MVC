...
<span id="show_text">System Management <img broder="0" src="/images/system/slide.gif"/> Dictionary List</span>
</div>

<form id="myform" action="${request.getContextPath()}/dictionary/delall" method="POST">
...
<td>${list.type?default("")}&nbsp;</td>
<td>
<a href="${request.getContextPath()}/dictionary/get/${list.id?default('')}">Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;
<a href="${request.getContextPath()}/dictionary/del/${list.id?default('')}" onclick="javascript:return p_del()">Delete</a>
</td>
</tr>
</#list>
 <#else>
