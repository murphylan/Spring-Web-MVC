...
<span id="show_text">System Management <img broder="0" src="/images/system/slide.gif"/> Authority List</span>
</div>
...
<td>
<a href="${request.getContextPath()}/security/getauthority/${list.id?default('')}">Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;
<#-- 
<a href="${request.getContextPath()}/security/delauthority/${list.id?default('')}" onclick="javascript:return p_del()">Delete</a>
-->
</td>
</tr>
</#list>
...
<div class="right"><@comm.pages/>&nbsp;</div>
<div class="clr">&nbsp;</div>
</body>
</html>